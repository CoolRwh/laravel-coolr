...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            ...
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="{{url('admin/welcome')}}" frameborder="0" data-id="{{url('admin/welcome')}}" seamless>

            </iframe>
        </div>
        <div class="footer">
            <div class="pull-right">&copy; 2014-2015 <a href="" target="_blank">shiqingliang</a>
            </div>
        </div>
    </div>
    <!--右侧部分结束-->
