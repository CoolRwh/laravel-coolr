...
<script src="{{@asset('static/admin/js/plugins/flot/jquery.flot.js')}}"></script>
<script src="{{@asset('static/admin/js/plugins/flot/jquery.flot.tooltip.min.js')}}"></script>
<script src="{{@asset('static/admin/js/plugins/flot/jquery.flot.resize.js')}}"></script>
<script src="{{@asset('static/admin/js/plugins/chartJs/Chart.min.js')}}"></script>
