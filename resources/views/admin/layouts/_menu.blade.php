        ...
        <ul class="nav" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element" >
                   <img alt="image" style="width: 50px;" class="img-circle" src="https://i.loli.net/2020/01/12/aBN8K1wsjEkqzc6.jpg"/>
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        ...
                        <li><a class="J_menuItem" href="{{route('admin.cate.edit',[1])}}">修改头像</a></li>
                    </ul>
                </div>
            ...
            @foreach($menu as $menus)
                @if($menus['next'] !== '') <li>
                    ...
                    <ul class="nav nav-second-level">
                        @foreach($menus['next'] as $v)
                        <li>
                            <a class="J_menuItem" href="{{$v['url']}}" data-index="0">{{$v['title']}}</a>
                        </li>
                            @endforeach
                    </ul>
         ...
         {{--   <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    <li>
                        <a class="J_menuItem" href="{{route('admin.article.list')}}">文章列表</a>
                    </li>
                </ul>
            </li>
            <li>
